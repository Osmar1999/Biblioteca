...
class Libros extends Component
{
    ...
    public $selected_id, $keyWord, $titulo_libro, $edicion_libro, $fecha_lanzamiento_libro, $idioma_libro, $descripcion_libro, $paginas_libro, $categoria_id, $autor_id, $editorial_id;
